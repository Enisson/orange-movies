...
export default function MoreTv({genre, filter, page}) {
    ...
    useEffect( ()=> {
        fetch(`https://api.themoviedb.org/3/discover/tv?api_key=${apikey}&sort_by=${filter}&with_genres=${genre}&language=pt-BR&page=${page}`)
